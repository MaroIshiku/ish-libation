...
ARG USER_UID=1001
ARG USER_GID=1001
ARG ISH_LIBATION_VERSION=dev
ARG ISH_LIBATION_COMMIT=unknown
ARG ISH_LIBATION_BUILD_DATE=unknown

ENV NODE_ENV=production
ENV ISH_LIBATION_VERSION=${ISH_LIBATION_VERSION}
ENV ISH_LIBATION_COMMIT=${ISH_LIBATION_COMMIT}
ENV ISH_LIBATION_BUILD_DATE=${ISH_LIBATION_BUILD_DATE}
ENV PORT=3000
ENV LANG=C.UTF-8
ENV LC_ALL=C.UTF-8
